                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>
                                    <img src="${o.product_img_source}">
                                </td>
                                <td>${o.product_price}</td>
                                <td>
                                    <a href="load?pid=${o.product_id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        <c:forEach begin="1" end="${pageEnd}" var="i">
                            <li class="page-item"><a href="manager?index=${i}" style="${tag==i?"color: red":""}">${i}</a></li>
                            </c:forEach>
                    </ul>
                </div>
            </div>
